...
public class HowToHandelCalendarORTextBoxORSelectBox {
	...
	public void enterText() throws InterruptedException{
		...
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("vadod");
		...
		WebElement adult = driver.findElement(By.id("adultPlusBtn"));
		adult.click();
		adult.click();
		adult.click();
		...
		WebElement child = driver.findElement(By.xpath("//button[@id='childPlusBtn']/i"));
		child.click();
		child.click();
		child.click();
	}
